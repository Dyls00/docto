...
<div class="mb-3">
    <h2 class="text-center" style="color: #0C655A; font-size: 70px; margin-top: 1em;">CONNECTEZ-VOUS</h2>
    <p class="text-center" style="margin-bottom: 3em;">
        Saississez votre email et votre mot de passe afin de vous connecter à votre compte.
    </p>
            ...
            <div class="div-form-login shadow" style="background-color: lightgray; width: 40%; border-radius: 20px; padding: 20px;">
                <div class="container justify-content-center align-items-center flex-column" style="display:flex; flex-direction:row;">
                    ...
                    <div class="container text-center">
                        ...
                        <div class="mb-3 col-6; container text-center">
                            <a href="../inscriptionUtilisateur/inscriptionUtilisateur.php" class="btn btn-primary" style="background-color: orange;border:none; border-radius: 20px;"> S'inscrire</button></a>
                        </div>
                        <div class="mb-3 col-6; container text-center">
                            <a href="./emailPasswordReset.php" class="btn btn-primary btn-sm" style="background-color: #9C6C49; border-radius: 20px;border:none;">Mot de passe oublié</a>
                        </div>
                    </div>
                </div>
            </div>
