                ...
                <div class="col-md-10">
                    <div class="card-body">
                        ...
                        <div class="card mb-3 offset-md-2">
                            ...
                            <div class="card-header">Spécialités en attente de confirmation</div>
                            ...
                            <tbody>
                                <?php
                                $sql2 = "select * from dl_specialities WHERE specialite_validate = 0";
                                ...
                                if (count($results2) > 0) {
                                    foreach ($results2 as $result2) {
                                        $id3 = $result2['specialite_id'];
                                ?>
                                        <tr>
                                            <td class="text-center"><?php echo ($cnt); ?></td>
                                            <td class="text-center"><?php echo ($results2[0]['specialite_id']); ?></td>
                                            <td class="text-center"><?php echo ($results2[0]['specialite_name']); ?></td>
                                            <td class="text-center text-primary"><a type="button" href="dashboardSpecialiteValidate.php?id=<?php echo ($id3) ?>"><i class="fas fa-check btn btn-secondary"></i></a></td>
                                            <td class="text-center text-danger"><a type="button" href="dashboardSpecialiteDecline.php?id=<?php echo ($id3) ?>"><i class="fas fa-trash-alt"></i></a></td>
                                            <td class="text-center">
                                            <a type="button" href="dashboardSpecialiteValidate.php?id=<?php echo $id3; ?>">
                                                <i class="fas fa-check btn btn-secondary"></i>
                                            </a>
                                                <td class="text-center">
                                                <a type="button" href="dashboardSpecialiteDecline.php?id=<?php echo $id3; ?>">
