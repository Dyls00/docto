...
<head>
  ...
  <title>Doctolib | Spécialistes</title>
</head>
...
<body>
  ...
  <div class="container pt-5">
    ...
    <div class="col-md-3 pt-3">
      ...
      <!-- Récupération de tous les Spécialistes affichés dans un tableau, option pour voir plus de détails sur un spécialiste/modifier/supprimer -->
      ...
      <div class="col-md-10">
        <div class="card-body">
          ...
          <div class="card mb-3 larger-card">
            ...
            <div class="card-header">Spécialistes enregistrés</div>
            ...
            <tbody>
              <?php
              $sql = "SELECT * FROM dl_doctor WHERE doctor_validate = 1";
              ...
              ?>
                  <tr>
                    ...
                    <td class="text-center"><?php echo $result['doctor_code_RPPS']; ?></td>
                    <td class="text-center"><?php echo $result['doctor_tel']; ?></td>
                    <td class="text-center text-danger">
                      <a href="dashboardDoctorDelete.php?id=<?php echo $id; ?>">
