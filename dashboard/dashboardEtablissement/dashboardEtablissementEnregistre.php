        ...
        <div class="col-md-10">
          ...
          <div class="card mb-3 larger-card">
              <table class="table table-striped table-bordered table-hover mt-1">
                <div class="card-header">Etablissements enregistrés</div>
                ...
                <tbody>
                  ...
                  $sql = "select * from dl_etablissement where etablissement_validate = 1";
                  ...
                  ?>
                      <tr>
                        ...
                        <td class="text-center"><?php echo($result['etablissement_id']); ?></td>
                        <td class="text-center"><?php echo($result['etablissement_name']); ?></td>
                        <td class="text-center"><?php echo($result['etablissement_adress']); ?></td>
                        <td class="text-center"><?php echo($result['etablissement_city']); ?></td>
                        <td class="text-center"><?php echo($result['etablissement_tel']); ?></td>
                        <td class="text-center"><?php echo($result['etablissement_capacity']); ?></td>
                        <td class="text-center text-danger"><a type="button" href="dashboardEtablissementDelete.php?id=<?php echo($id)?>"><i class="fas fa-trash-alt"></i></a></td>
                      </tr>
                  <?php
                      $cnt = $cnt + 1;
                    }
